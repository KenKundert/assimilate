...
INITIAL_SHARED_SETTINGS_FILE_CONTENTS = dedent(
    ...
    encryption: ⟪encryption⟫
        # borg encryption method
        # Common choices are ‘repokey’, ‘keyfile’, and ‘none’.
        # With ‘repokey’ the encryption key is copied into repository, use this
        # only if the repository is owned by you and is secure.
        ...
        # With ‘none’ the repository is not encrypted.  This is generally only
        # used with local caches where encryption would serve no purpose.
    # specify either passphrase or pass_command if using encryption
    passphrase: ⟪passcode⟫
    pass command: ⟪account-name⟫'    # avendesora account holding passphrase
    ...
    compression: lz4
        # lz4 is a fast algorithm that provides reasonable compression
